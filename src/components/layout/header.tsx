                ...
                <Popover>
                    <PopoverTrigger asChild>
                        <div className="flex cursor-pointer select-none text-gray-900 items-center gap-3 text-[14px] font-medium">
                            ...
                            AlexanderW@example.com
                        </div>
                    </PopoverTrigger>
                    <PopoverContent className="w-40 h-11 mt-3 flex items-center justify-center gap-x-3 rounded-xl shadow-2xl !border-[#E5E7EB]">
                        <LogOut className="rotate-180 size-5" />
                        <p className="text-gray-700 text-[14px]">Log Out</p>
                    </PopoverContent>
                </Popover>
