...
import { CardTable as ActivityTable } from "@/components/ui/table/card-table";
    ...
    return (
        <div className="bg-background rounded-lg">
            <div className="w-full rounded-t-lg bg-white p-5 flex items-center h-20">
                <h2 className="font-bold font-inter text-2xl">Viator</h2>
            </div>
            <ActivityTable columns={columns} data={tableData} totalItems={tableData.length} />
        </div>
    );
}
