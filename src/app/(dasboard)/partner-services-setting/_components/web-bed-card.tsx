...
import { CardTable as WebBedTable } from "@/components/ui/table/card-table";
...
export default function WebBedCard() {
    ...
    return (
        <div className="bg-background rounded-lg">
            ...
            <WebBedTable columns={columns} data={tableData} totalItems={tableData.length} />
        </div>
    );
}
